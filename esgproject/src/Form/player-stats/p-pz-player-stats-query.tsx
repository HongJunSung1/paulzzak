...
const PlayerStatsQuery = ({strOpenUrl, openTabs}: FormPlayerStatsQueryProps) => {
    ...
    const headerOptions = useMemo(() => {
     ...
     const columns1 = useMemo(() => ([
        ...
        {name : "GameCount"     , header: "참석수"      , width:  65, renderer: {type: "number"}, sortable: true},
        // {name : "GameCount"     , header: "참석수"      , width:  40, renderer: {type: "number"}},
        {name : "GameRatio"     , header: "참석율"      , width:  65, renderer: {type: "number"}, sortable: true},
        {name : "TotalScore"    , header: "전체득점"    , width:  75, renderer: {type: "number"}, sortable: true},
        {name : "TwoPSuccess"   , header: "득점"        , width:  55, renderer: {type: "number"}, sortable: true},
        {name : "TwoPAttempt"   , header: "시도"        , width:  55, renderer: {type: "number"}, sortable: true},
        {name : "TwoPRatio"     , header: "성공률"      , width:  65, renderer: {type: "number"}, sortable: true},
        {name : "ThreePSuccess" , header: "득점"        , width:  55, renderer: {type: "number"}, sortable: true},
        {name : "ThreePAttempt" , header: "시도"        , width:  55, renderer: {type: "number"}, sortable: true},
        {name : "ThreePRatio"   , header: "성공률"      , width:  65, renderer: {type: "number"}, sortable: true},
        {name : "FTSuccess"     , header: "득점"        , width:  55, renderer: {type: "number"}, sortable: true},
        {name : "FTAttempt"     , header: "시도"        , width:  55, renderer: {type: "number"}, sortable: true},
        {name : "FTRatio"       , header: "성공률"      , width:  65, renderer: {type: "number"}, sortable: true},
        {name : "Rebound"       , header: "개수"        , width:  60, renderer: {type: "number"}, sortable: true},
        {name : "AVGRebound"    , header: "평균"        , width:  55, renderer: {type: "number"}, sortable: true},
        {name : "Assist"        , header: "개수"        , width:  55, renderer: {type: "number"}, sortable: true},
        {name : "AVGAssist"     , header: "평균"        , width:  55, renderer: {type: "number"}, sortable: true},
        {name : "Steal"         , header: "개수"        , width:  55, renderer: {type: "number"}, sortable: true},
        {name : "AVGSteal"      , header: "평균"        , width:  55, renderer: {type: "number"}, sortable: true},
        {name : "Block"         , header: "개수"        , width:  55, renderer: {type: "number"}, sortable: true},
        {name : "AVGBlock"      , header: "평균"        , width:  55, renderer: {type: "number"}, sortable: true},
        {name : "TurnOver"      , header: "개수"        , width:  55, renderer: {type: "number"}, sortable: true},
