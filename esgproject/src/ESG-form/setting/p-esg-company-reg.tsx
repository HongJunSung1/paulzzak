        ...
        <div style={{top: 0 ,height:"100%", display : strOpenUrl === '/PEsgCompanyReg' ? "flex" : "none", flexDirection:"column"}}>
            ...
            <DynamicArea>
                <Splitter SplitType={"horizontal"} FirstSize={50} SecondSize={50}>
                    <Grid ref={grid1Ref} gridId="DataSet1" title = "회사 정보"       source = {grid1Data} headerOptions={headerOptions} columns = {columns1} onChange={handleGridChange} addRowBtn = {true} onClick={gridClick}/>
                    <Grid ref={grid2Ref} gridId="DataSet2" title = "사업부문 정보"   source = {grid2Data} headerOptions={headerOptions} columns = {columns2} onChange={handleGridChange} addRowBtn = {true} onClick={gridClick}/>
                </Splitter>
            </DynamicArea>
        </div>
    )
