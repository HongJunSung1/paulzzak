...
const Scope3 = ({strOpenUrl, openTabs, setIsDataChanged}) => {
    ...
    const toolbar = [  
     ...
     const columns1 = [
        ...
        {name : "PurItemService"       , header: "구매한 제품\n및 서비스"               , width: 100, editor: 'text', renderer: {styles: {fontWeight: 'normal'}, classNames: ['my-class'],}},
        {name : "CapitalGoods"         , header: "자본재"                                , width: 100, editor: 'text'},
        {name : "ExceptFuelEnergy"     , header: "Scope 1,2에 포함되지\n않는 연료&에너지", width: 150, editor: 'text'},
        {name : "UpLogistics"          , header: "업스트림 운송\n및 물류"                , width: 100 , editor: 'text'},
        {name : "WorkWasted"           , header: "작업 중 발생한\n폐기물"                , width: 100 , editor: 'text'},
        {name : "BusinessTrip"         , header: "출장"                                  , width: 100 , editor: 'text'},
        {name : "Commute"              , header: "직원 출퇴근"         , width: 100 , editor: 'text'},
        {name : "UpLeaseProperties"    , header: "업스트림\n임대(차) 자산"         , width: 100 , editor: 'text'},
        {name : "DownLogistics"        , header: "다운스트림\n운송 및 물류"         , width: 100 , editor: 'text'},
        {name : "SoldItemManufacturing", header: "판매된\n제품의 가공"         , width: 100 , editor: 'text'},
        {name : "SoldItemUse"          , header: "판매된\n제품의 사용"         , width: 100 , editor: 'text'},
        {name : "SoldItemWasted"       , header: "판매된\n제품의 폐기"         , width: 100 , editor: 'text'},
        {name : "DownLeaseProperties"  , header: "다운스트림\n임대(차)자산"         , width: 100 , editor: 'text'},
        {name : "Franchise"            , header: "프랜차이즈"         , width: 100 , editor: 'text'},
        {name : "Investment"           , header: "투자"         , width: 100 , editor: 'text'},
        {name : "OtherUpEmission"      , header: "기타 업스트림\n배출량"         , width: 100 , editor: 'text'},
        {name : "OtherDownEmission"    , header: "기타 다운스트림\n배출량"         , width: 100 , editor: 'text'},
    ];
